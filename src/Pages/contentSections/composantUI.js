    ...
    <Container>
      ...
      <Div>
        ...
        <Comp>
          {
            allContent ?
              allContent.sort(((a,b) => b.impression - a.impression)).map((Content, i) => i < 6 && <CardUI key={i} imgSrc={Content.imgs} tag={Content.tag} title={Content.title} author={Content.author} id={Content.id} type={Content.tag} impression={Content.impression}/>)
              :
